...
int PolygonsExample::Beginner::OnAdd(float& x, float& y)
{
...
int PolygonsExample::Beginner::OnAct(sint32& type, float& vx, float& vy)
{
    if(type == 0)
    {
...
int PolygonsExample::Beginner::OnScore(sint32 type)
{
    if(type == 1)
        return 100;
    if(type == 2)
...
void PolygonsExample::Beginner::OnRender(ZayPanel& panel, sint32 type, sint32 ani)
{
