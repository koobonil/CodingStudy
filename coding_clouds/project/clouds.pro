...
SOURCES += ../source/clouds.cpp
HEADERS += ../source/clouds.hpp
SOURCES += ../source/clouds_example.cpp
HEADERS += ../source/clouds_example.hpp
SOURCES += ../source/clouds_example_beginner.cpp
SOURCES += ../source/clouds_example_junior.cpp
SOURCES += ../source/clouds_example_senior.cpp
