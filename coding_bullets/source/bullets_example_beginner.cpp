...
int BulletsExample::Beginner::OnAdd(float& x, float& y, float& r)
{
...
int BulletsExample::Beginner::OnAct(int& type, float& vx, float& vy)
{
	if(type == 0)
    {
...
Eff BulletsExample::Beginner::OnEff(int type)
{
    return Eff::LINEUP;
}

void BulletsExample::Beginner::OnRender(ZayPanel& panel, int type)
{
    if(type == 1)
    {
...
int BulletsExample::Beginner::OnRenderUser(ZayPanel& panel, int id, float vx, float vy)
{
