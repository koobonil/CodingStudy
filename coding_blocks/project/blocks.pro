...
SOURCES += ../source/blocks_example.cpp
HEADERS += ../source/blocks_example.hpp
SOURCES += ../source/blocks_example_beginner.cpp
SOURCES += ../source/blocks_example_junior.cpp
SOURCES += ../source/blocks_example_senior.cpp
